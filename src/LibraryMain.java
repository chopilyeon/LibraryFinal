...
public class LibraryMain {
    public static void main(String[] args){
		...
		joinlist.put(new Member02("조재희","9503051411711"),new Member("jaehee3679","4a5s6d1f2g","01029523679"));
		loginlist.put(new Member("jaehee3679","4a5s6d1f2g"),new Member("조재희","4a5s6d1f2g","01029523679"));
        ...
        System.out.println("7.(매니저만)회원정보 보기");
