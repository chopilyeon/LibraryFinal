...
public class Modification {
	...
	public static void checkout(HashMap<Member02,Member02> joinlist) {
	...
	//비밀번호 변경해주기 시스템
	public static void modify(HashMap<Member02,Member02> joinlist,HashMap<Member,Member> loginlist,HashMap<Member,Book> booklist) {
		...
		if(loginlist.containsKey(new Member(id,password))){
			...
			joinlist.put(new Member02(name,identity),new Member02(id,newPassword,phonenumber));
